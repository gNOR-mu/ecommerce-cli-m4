...
public class InventoryService implements IdentifiableService<Inventory, Long> {
     ...
     * @throws InvalidOperationException      Cuando el inventario es inferior a 0 (quantity < 0)
     * @throws ResourceAlreadyExistsException Cuando ya existe un inventario para un producto.
     */
    public Inventory create(Inventory inventory) {
        if (inventory.getQuantity() < 0) {
            throw new InvalidOperationException("El inventario no puede ser inferior a 0");
        }

        if (inventoryRepository.existsById(inventory.getProductId())) {
            throw new ResourceAlreadyExistsException("Ya existe un inventario para el producto con id : " + inventory.getProductId());
        }
     ...
     * @throws InvalidOperationException Cuando el inventario aún presenta productos. (quantity > 0).
     *
     */
    public void deleteByProductId(Long productId) {
        ...
        if (inventory.getQuantity() > 0) {
            throw new InvalidOperationException("No se puede eliminar un inventario con cantidad de productos > 0");
        }
     ...
     * @throws InvalidOperationException Cuando el inventario es inferior a 0
     */
     ...
     * @throws ResourceNotFoundException Cuando no se encuentra un inventario con la id correspondiente
     */
     ...
     * @throws InvalidOperationException Cuando se intenta reducir más productos del stock disponible
     */
    public void subtractInventory(Long productId, int quantity) {
        Inventory inventory = getByProductId(productId);
        int newQuantity = inventory.getQuantity() - quantity;
        if (newQuantity < 0) {
            throw new InvalidOperationException("No puede haber un stock negativo");
        }
